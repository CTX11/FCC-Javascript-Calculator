...
class App extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("button", { className: "sienna", onClick: this.handleClick, id: "decimal" }, ".")), /*#__PURE__*/
      ...
      React.createElement("button", { className: "sienna", onClick: this.handleClick, id: "equals" }, "="))));
